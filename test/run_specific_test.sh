...
colcon test --packages-select mrs_uav_autostart --ctest-args -R 'takeoff_trigerred_externally' --event-handlers console_direct+ console_stderr- console_start_end-
